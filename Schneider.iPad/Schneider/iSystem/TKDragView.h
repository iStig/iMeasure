...
@interface TKDragView : UIView <UIGestureRecognizerDelegate> {
    ...
    @protected
    NSDictionary *_dictDeviceInfo;
}

/*
    custom property for Schneider, remember device information
 */
@property (nonatomic, retain) NSDictionary *dictDeviceInfo;
...
- (NSInteger)currentGoodFrameIndex;
